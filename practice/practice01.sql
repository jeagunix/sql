...
select count(*) as '현재 직원수' from salaries where to_date like '9999%';
...
select count(*) as '현재 부서 매니저 수'from dept_manager where to_date like '9999%';
...
select count(emp_no) from titles where title = 'Engineer' and to_date like '9999%';
